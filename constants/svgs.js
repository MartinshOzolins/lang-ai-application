...
export function DownloadWithAnswersSvg() {
  return (
    <span className="pr-2">
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export function DownloadWithoutAnswersSvg() {
  return (
    <span className="pr-2">
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export function HamburgerButtonSvg({ onClick }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function CloseIconSvg({ onClick }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
